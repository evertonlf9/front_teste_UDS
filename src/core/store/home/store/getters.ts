...
export const getCustomizationSelected = ({ customizationSelected }: any) => customizationSelected
export const getDataList = ({ data }: any) => data
export const getTime = ({ time }: any) => time
export const getTotal = ({ total }: any) => total
export const getState = ({key, time, total, sizeSelected, flavorSelected, customizationSelected}: any) => {
    return {key, time, total, sizeSelected, flavorSelected, customizationSelected}
}
